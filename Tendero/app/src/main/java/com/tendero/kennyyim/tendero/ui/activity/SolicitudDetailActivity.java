            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    if (session != null){
                        ...
                        message.setContent(solicitud.getTextSolicitud(),"text/html; charset=utf-8");
                        Transport.send(message);

                        Solicitud newSolicitud = new Solicitud(solicitud.getId(),solicitud.getTextSolicitud(),edtEmail.getText().toString());
